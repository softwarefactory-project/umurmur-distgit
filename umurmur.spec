...
install -p -D -m 0640 umurmur.conf.example %{buildroot}%{_sysconfdir}/umurmur/umurmurd.conf
...
%dir %attr(0750, umurmurd, umurmurd) %{_sysconfdir}/umurmur
%attr(0750, root, umurmur) %{_sysconfdir}/umurmur/umurmurd.conf
